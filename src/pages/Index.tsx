...
const PRODUCTS = [
  {
    id: 1,
    name: "Oden's Extreme Cold",
    category: "chew",
    price: 390,
    oldPrice: 490,
    tag: "HOT",
    description: "Шведский снюс, ледяная мята, сильная крепость",
  ...
  },
  {
    ...
    oldPrice: null,
    tag: null,
    description: "Классический шведский снюс, табачный вкус",
    image: "https://cdn.poehali.dev/projects/cd0f878d-a017-44b8-8994-4fa16cb30734/files/d4d90fda-f18a-471a-987d-0323dccf082f.jpg",
    rating: 4.7,
    reviews: 198,
    nicotine: "8мг",
  },
  {
    ...
    oldPrice: null,
    tag: "NEW",
    description: "Экстремально крепкий, арктический холод",
    image: "https://cdn.poehali.dev/projects/cd0f878d-a017-44b8-8994-4fa16cb30734/files/d4d90fda-f18a-471a-987d-0323dccf082f.jpg",
    rating: 4.8,
    reviews: 541,
    nicotine: "43мг",
  },
  {
    ...
    oldPrice: 650,
    tag: "HOT",
    description: "Ягодный микс с ледяным эффектом, соль 50мг",
  ...
  },
  {
    ...
    oldPrice: null,
    tag: "NEW",
    description: "Манго + личи + маракуйя, соль 20мг",
    image: "https://cdn.poehali.dev/projects/cd0f878d-a017-44b8-8994-4fa16cb30734/files/cae91314-d8fc-41d5-b3bc-593a56383116.jpg",
    rating: 4.8,
    reviews: 211,
    nicotine: "20мг",
  ...
  {
    id: 7,
    name: "Nicorette Spearmint",
    category: "patches",
    price: 590,
    oldPrice: 750,
    tag: "HOT",
    description: "Никотиновые пластинки, мята, 2мг, 20шт",
  ...
  },
  {
    ...
    oldPrice: null,
    tag: "NEW",
    description: "Никотиновые пакетики без табака, морозная мята",
    image: "https://cdn.poehali.dev/projects/cd0f878d-a017-44b8-8994-4fa16cb30734/files/b0a04bdf-7a52-446c-8ba8-28e85c61e196.jpg",
    rating: 4.7,
    reviews: 97,
    nicotine: "6мг",
  ...
  },
  {
    ...
    oldPrice: null,
    tag: null,
    description: "Сменный картридж 2мл, 0.8Ω mesh, 2шт",
    image: "https://cdn.poehali.dev/projects/cd0f878d-a017-44b8-8994-4fa16cb30734/files/d4d90fda-f18a-471a-987d-0323dccf082f.jpg",
    rating: 4.6,
    reviews: 74,
    nicotine: null,
  ...
  {
    id: 14,
    name: "Испаритель SMOK RPM",
    category: "accessories",
    price: 290,
    oldPrice: 390,
    tag: "HOT",
    description: "Сменный испаритель 0.4Ω, 5шт в упаковке",
    image: "https://cdn.poehali.dev/projects/cd0f878d-a017-44b8-8994-4fa16cb30734/files/d4d90fda-f18a-471a-987d-0323dccf082f.jpg",
    rating: 4.5,
    reviews: 156,
    nicotine: null,
...
const CATEGORIES = [
  { id: "all", label: "ВСЕ" },
  { id: "chew", label: "ЖЕВ. ТАБАК" },
  { id: "liquid", label: "ЖИДКОСТИ" },
  { id: "patches", label: "ПЛАСТИНКИ" },
  { id: "disposable", label: "ОДНОРАЗКИ" },
  { id: "pod", label: "ПОД СИСТЕМЫ" },
